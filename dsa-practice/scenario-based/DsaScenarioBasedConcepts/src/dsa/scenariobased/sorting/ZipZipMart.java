...
//creating a class to sort sales report on amounts using merge sort
public class ZipZipMart {
  ...
  //method to display arr
    ...
    public static void main(String[] args) {
    	...
    	int size =sc.nextInt();
    	int[] salesAmount = new int[size];
    	for(int i=0; i<size; i++) {
    		System.out.println("Enter registration timr of "+(i+1)+" artist :");
    		salesAmount[i]=sc.nextInt();
    	}
	
    	//displaying results
    	System.out.println("\nBefore sorting : ");
    	printArr(salesAmount);
    	System.out.println("\nAfter sorting : ");
    	mergeSort(salesAmount, 0, salesAmount.length - 1);
    	printArr(salesAmount);
